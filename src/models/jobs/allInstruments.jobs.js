...
//         //   //   const myInstruments = await axios("https://api.robinhood.com/positions/?nonzero=true", {
//         //   //   "headers": {
//         //   //     "accept": "*/*",
//         //   //     "accept-language": "en-US,en;q=0.9",
//         //   //     "authorization": authToken,
...
//         //   //   "mode": "cors"
//         //   // });
//         //   // console.log('myInstruments', myInstruments.data.results[0]);
//       } catch (err) {
...
//   // https://www.nasdaq.com/market-activity/stocks/dis/dividend-history
...
//       await emptyDB();
//       // console.log("end recursive loop", saveAllInstruments.length);// 14100;
//       // const getInstruments = await getDoc()
...
//       fs.writeFile("./connection/config/json/test1.json", jsonContent1, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test2.json", jsonContent2, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test3.json", jsonContent3, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test4.json", jsonContent4, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test5.json", jsonContent5, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test6.json", jsonContent6, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test7.json", jsonContent7, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test8.json", jsonContent8, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test9.json", jsonContent9, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test10.json",jsonContent10, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test11.json",jsonContent11, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test12.json",jsonContent12, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test13.json",jsonContent13, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test14.json",jsonContent14, 'utf8', resolve);
//       fs.writeFile("./connection/config/json/test15.json",jsonContent15, 'utf8', resolve);
